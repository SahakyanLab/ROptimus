...
m <- function(K,
              ...
              mopac.cmd="/Users/alex/prog/mopac2016/MOPAC2016.exe",
              clean = TRUE,
              name = "conf1"){

  #m(K=c(PHI=90.0, PSI=90.0), notconvergedE = -100.00,
  #  mopac.cmd="/Users/alex/prog/mopac2016/MOPAC2016.exe", clean=FALSE)
  ...
  # half a second.
  random.id <- name # as.character(sample(size=1, x=1:10000000))
...
PHI <- c(180.0, 50.0, 90.0, 94.0)
PSI <- c(180.0, 188.0, 76.0, 74.0)
for(i in 1:4){
  m( K=c(PHI=PHI[i], PSI=PSI[i]),
     notconvergedE = -100.00,
     mopac.cmd="/Users/alex/prog/mopac2016/MOPAC2016.exe",
     clean=FALSE,
     name=paste0("conf",i))
