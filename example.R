...
################################################################################
plot(x=x, y=y, col=rgb(0.5,0.5,0.9,0.3), pch=16, cex=0.8, main="Synthetic example dataset")
################################################################################
...
################################################################################
plot(x=x, y=y, col=rgb(0.5,0.5,0.9,0.3), pch=16, cex=0.8, main="Least-squares linear model fitting")
